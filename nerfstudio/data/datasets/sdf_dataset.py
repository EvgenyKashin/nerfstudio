...
class SDFDataset(InputDataset):
    ...
    def __init__(self, dataparser_outputs: DataparserOutputs, scale_factor: float = 1.0):
        ...
        self.camera_to_worlds = dataparser_outputs.cameras.camera_to_worlds
        # can be none if auto orient not enabled in dataparser
        self.transform = None # self.metadata["transform"]
        self.include_mono_prior = False # self.metadata["include_mono_prior"]
