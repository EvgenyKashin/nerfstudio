...
@dataclass
class LatentDataManagerConfig(base_datamanager.VanillaDataManagerConfig):
    """A depth datamanager - required to use with .setup()"""

    _target: Type = field(default_factory=lambda: LatentDataManager)


class LatentDataManager(base_datamanager.VanillaDataManager):  # pylint: disable=abstract-method
